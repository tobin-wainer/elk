...
This package allows you to download, correct, analyze and visualize *integrated* light curves from TESS FFI data using the methods outlined in `Wainer+2023 <https://ui.adsabs.harvard.edu/abs/2023arXiv230709510W/abstract>`_. While originally designed for analysis of star clusters, it can be used to create integrated light curves for any given aperture.
